...
class TripNet(torch.nn.Module):
    ...
    def __init__(self, weights):
        ...
        self.denseNet = torch.load(weights).cpu() #my finetuned model
...
class TriNetClassifier(torch.nn.Module):
    ...
    def __init__(self):
        ...
        self.featureExtractor = torch.load(os.path.join(os.getcwd(),'drive/My Drive/Best_triplet_23June.pt'))
        self.relu = torch.nn.ReLU(inplace=True)
        self.fc3 = torch.nn.Linear(128, 2).cuda()
